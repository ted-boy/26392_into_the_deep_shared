...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2166.8992723320744; // 0.0; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1902.149284643547; //0.0; // x position of the perpendicular encoder (in tick units)
    }
